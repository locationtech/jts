 ...
 *
 */
public class UnionHighPrecisionTest extends TestCase {
  
  public static void main(String args[]) {
    TestRunner.run(UnionHighPrecisionTest.class);
  }
...
Polygon p6 = createPolygon.apply(new double[][]{
  ...
  private void checkUnion(String title, Polygon p2, Polygon p3, Polygon p5) {
    Geometry p25 = p2.union(p5);
    Geometry pall = p3.union(p25);
