...
/**
 * Union MultiPolygons
 * with topological union processing limited to the elements which lie in the
 * common envelope.
 * 
 * @author mbdavis
 *
 */
public class InteractionEnvelopeUnion 
{
	public static Geometry union(Geometry g0, Geometry g1)
	{
		InteractionEnvelopeUnion uue = new InteractionEnvelopeUnion(g0, g1);
		return uue.union();
	}
	...
	public InteractionEnvelopeUnion(Geometry g0, Geometry g1)
	{
		this.g0 = g0;
		this.g1 = g1;
...
//		}
		...
		Geometry union = unionGeometry(int0, int1);
  ...
  private Geometry unionGeometry(Geometry geom0, Geometry geom1) {
